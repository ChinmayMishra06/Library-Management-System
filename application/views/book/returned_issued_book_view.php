	...
	<div class="col">
		<div class="card">
			<div class="card-header p-0">
				<h4 class="text-center text-white">Returned Books Detail</h4>
			</div>
			<div class="card-body">
				<?php if(count($subscriber_book_details) > 0): ?>
					...
					<div class="row">
						<div class="col">
							<button type="button" id="returned_issued_book_print_button" name="returned_issued_book_print_button" class="d-print-none btn btn-outline-secondary">Print</button>
						</div>
...
<?php include_once(APPPATH.'views/sidebar_end.php'); ?>
	<script>
		...
		// This code will print the returned issued book details page on clicking print button.
		document.getElementById('returned_issued_book_print_button').addEventListener('click', function(){
			window.print();
		});
	</script>
