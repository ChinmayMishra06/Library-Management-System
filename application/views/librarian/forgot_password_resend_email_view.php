...
<div class="row">
	<div class="colform-center">
		<div class="card">
			<div class="card-body">
				<?= form_open(base_url('index.php/librarian/resend_forgot_email'), ["id"=>"forgot_password_resend_email_form", "name"=>"forgot_password_resend_email_form"]); ?>
...
<script>
	...
	window.addEventListener("load", function(e){
		document.getElementById("forgot_password_resend_email_form").submit();
	});
</script>
